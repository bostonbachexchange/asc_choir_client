    ...
    return (
        <>
            <Card style={aboutUsStyle} className='playFont'>
                        <h1 className="mt-3 ps-4 text-center" ><strong>Welcome to the All Souls Choir Website!</strong></h1>
                <div className='aboutUs'>
                    <div style={{flex: '6'}}>
                        <h2 className="mt-3 ps-4" style={{textDecoration: 'underline'}}><strong>About the Website</strong></h2>
                        ...
                        <h2 className="mt-3 ps-4" style={{fontSize: '32px', textDecoration: 'underline'}}><strong>About the Choir</strong>
                        </h2>
                        <p className="m-auto p-4">
